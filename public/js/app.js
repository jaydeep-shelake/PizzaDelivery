...
function initAdmin() {
  ...
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/admin', {
    headers: {
...
var addToCartBtn = document.querySelectorAll('.btn-cart');
var cartCounterDisplay = document.getElementById('cart-counter');
addToCartBtn.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizza); // converting pizza data from string to valid object
...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', pizza).then(function (res) {
    console.log(res);
    cartCounterDisplay.innerText = res.data.totalQty; // giving massage after adding to cart
...
Object(_admin__WEBPACK_IMPORTED_MODULE_2__["default"])(); // const addComment = document.getElementById('addComment');
...
var successAlert = document.getElementById('succes-alert');
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status, index) {
    ...
    if (dataStatus == order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.updatedAt).format('MMMM Do YYYY,h:mm:ss A');
...
__webpack_require__(/*! F:\practiceNode\PizzaDelivery\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! F:\practiceNode\PizzaDelivery\resources\scss\app.scss */"./resources/scss/app.scss");
